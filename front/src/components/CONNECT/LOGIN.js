        ...
        <div className='login'>
            ...
            <div className='box_login'>
                <form>
                    ...
                    <button type="submit" style={{backgroundColor:"#645FE5", width:"300px", padding:"10px 10px 10px 10px",marginLeft:"50px" , marginTop:"45px", borderRadius:"25px" }} onClick={() => login()}><span style={{color:'white' , fontWeight:"bold", fontSize:"20px"}}>Sign in</span></button>
